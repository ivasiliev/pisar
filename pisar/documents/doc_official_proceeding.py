...
class DocOfficialProceeding(InvestigationPrototype):
	...
	def render(self):
		...
		txt = f"4. {sold_str} за грубый дисциплинарный проступок, отсутствие на месте несения службы без уважительных причин более 4 (четырех) часов подряд в течении установленного ежедневного служебного времени, объявить СТРОГИЙ ВЫГОВОР."
