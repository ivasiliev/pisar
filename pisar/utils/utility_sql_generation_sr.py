    ...
    def render(self):
        ...
        try:
            ...
            for pers in all_persons:
                ...
                rank_assignment_date = dm["rank_assignment_date"]
            ...
            # exc_tb is a traceback object you can walk with traceback.extract_tb
            tb_list = traceback.extract_tb(exc_tb)
            print("Traceback list:", tb_list)
            self.log_ex(f"exc_type = {exc_type}")
            self.log_ex(f"exc_value = {exc_value}")
            self.log_ex(f"tb_list = {tb_list}")
