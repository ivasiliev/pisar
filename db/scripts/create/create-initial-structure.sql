...
ALTER TABLE [dbo].[RELATIVE_PERSON]  WITH CHECK ADD  CONSTRAINT [FK_RELATIVE_PERSON_RELATIVE_PERSON] FOREIGN KEY([RELATION_TYPE_ID])
REFERENCES [dbo].[GENERIC_DICT] ([ID])
GO

ALTER TABLE [dbo].[RELATIVE_PERSON] CHECK CONSTRAINT [FK_RELATIVE_PERSON_RELATIVE_PERSON]
GO
