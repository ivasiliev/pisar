...
* Отныне в файле Штатного расписания обязан присутствовать лист `ШБС`. На это листе следует расположить таблицу с данными военнослужащих. Остальные листы книги Excel игнорируются. Файл personnel_demo.xlsx имеет правильную структуру.
