...
* Служебное разбирательство по факту cамовольного оставления части
...
* `battalion`. Батальон.
* `phone_contact_to_report`. Номер телефона, по которому следует сообщить о самовольно оставившем воинскую часть.
...
**1.8 | 00.06.2023**
* Добавлен документ "Лист согласования" в группу "Служебное разбирательство по факту cамовольного оставления части".
* Добавлен ключ `military_unit_address`. Это адрес воинской части.
...
* В настройки Воинской части добавлены ключи: батальон и номер телефона (см. выше в списке параметров).
