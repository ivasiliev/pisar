...
## Файлы данных
Программа поставляется с демонстрационными файлами:
* `personnel-demo.xlsx`. Штатное расписание.
* `personnel-details-demo.xlsx`. Информация о военнослужащих. Данные о военнослужащих в обоих файлах сводятся по "Личный номер".
