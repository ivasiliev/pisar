...
* Развитие скриптов миграции.

**2.9 | 24.09.2025**

* Добавлена возможность миграции данных в БД на MS SQL Server.

**2.82 | 19.07.2025**

* Добавлен новый файл Должности.xlsx.
* Новый режим сортировки ЛС по должностям.
